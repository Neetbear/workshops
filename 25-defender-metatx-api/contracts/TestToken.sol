...
contract MyToken is Context, AccessControl, ERC20Burnable, ERC20Pausable {
     ...
     *
     */
    constructor(string memory name, string memory symbol, address _roleAddr) ERC20(name, symbol) {
        _setupRole(DEFAULT_ADMIN_ROLE, _roleAddr);
        _setupRole(MINTER_ROLE, _roleAddr);
        _setupRole(PAUSER_ROLE, _roleAddr);
    }
